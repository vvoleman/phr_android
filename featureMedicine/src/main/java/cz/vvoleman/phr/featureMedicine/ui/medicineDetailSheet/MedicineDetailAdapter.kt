package cz.vvoleman.phr.featureMedicine.ui.medicineDetailSheet
...
class MedicineDetailAdapter : ListAdapter<MedicineInfoUiModel, MedicineDetailAdapter.MedicineDetailViewHolder>(DiffCallback()) {
