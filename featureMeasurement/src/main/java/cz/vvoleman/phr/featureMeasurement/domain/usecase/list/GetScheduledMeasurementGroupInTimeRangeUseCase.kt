...
class GetScheduledMeasurementGroupInTimeRangeUseCase(
    ...
    BackgroundExecutingUseCase<GetScheduledMeasurementGroupInTimeRangeRequest, List<ScheduledMeasurementGroupDomainModel>>(
        coroutineContextProvider
    ) {

    override suspend fun executeInBackground(request: GetScheduledMeasurementGroupInTimeRangeRequest): List<ScheduledMeasurementGroupDomainModel> {
