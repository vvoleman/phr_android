...
class GetProblemCategoriesUseCase(
    private val eventBusChannel: EventBusChannel<GetProblemCategoriesAdditionalInfoEvent, Map<ProblemCategoryDomainModel, ProblemCategoryInfoDomainModel>>,
    private val getProblemCategoriesRepository: GetProblemCategoriesRepository,
    coroutineContextProvider: CoroutineContextProvider
) :
    BackgroundExecutingUseCase<GetProblemCategoriesRequest, List<ProblemCategoryWithInfoDomainModel>>(coroutineContextProvider) {
