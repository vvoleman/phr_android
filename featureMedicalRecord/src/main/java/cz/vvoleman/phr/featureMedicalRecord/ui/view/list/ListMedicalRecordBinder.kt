...
class ListMedicalRecordBinder(
...
) : BaseViewStateBinder<ListMedicalRecordViewState, FragmentListMedicalRecordsBinding, ListMedicalRecordBinder.Notification>(),
    ...
    private var previousState: ListMedicalRecordViewState? = null
    ...
    override fun bind(
        viewBinding: FragmentListMedicalRecordsBinding,
        viewState: ListMedicalRecordViewState
    ) {
